...
interface ICoFiXGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class ICoFiXGovernance extends BaseContract {
  ...
  interface: ICoFiXGovernanceInterface;
