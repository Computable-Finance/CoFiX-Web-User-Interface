...
export class Timelock extends BaseContract {
  ...
  filters: {
    ...
    NewAdmin(newAdmin?: string | null): TypedEventFilter<[string], { newAdmin: string }>

    NewDelay(newDelay?: BigNumberish | null): TypedEventFilter<[BigNumber], { newDelay: BigNumber }>

    NewPendingAdmin(newPendingAdmin?: string | null): TypedEventFilter<[string], { newPendingAdmin: string }>
  ...
  estimateGas: {
    ...
    setDelay(delay_: BigNumberish, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
