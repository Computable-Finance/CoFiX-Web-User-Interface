...
interface CoFiXStakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export class CoFiXStakingRewards extends BaseContract {
  ...
  interface: CoFiXStakingRewardsInterface
