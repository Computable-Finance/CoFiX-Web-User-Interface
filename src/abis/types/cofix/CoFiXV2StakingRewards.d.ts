...
interface CoFiXV2StakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export class CoFiXV2StakingRewards extends BaseContract {
  ...
  interface: CoFiXV2StakingRewardsInterface
