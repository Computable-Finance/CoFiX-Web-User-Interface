...
interface CNodeStakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export class CNodeStakingRewards extends BaseContract {
  ...
  interface: CNodeStakingRewardsInterface
