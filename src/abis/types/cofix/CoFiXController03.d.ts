...
interface CoFiXController03Interface extends ethers.utils.Interface {
  functions: {
    ...
    'calcK(int128,uint256)': FunctionFragment
  }
...
export class CoFiXController03 extends BaseContract {
  ...
  interface: CoFiXController03Interface
