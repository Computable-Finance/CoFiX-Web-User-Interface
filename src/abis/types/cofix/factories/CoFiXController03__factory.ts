...
import type { CoFiXController03, CoFiXController03Interface } from '../CoFiXController03'
...
export class CoFiXController03__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): CoFiXController03 {
