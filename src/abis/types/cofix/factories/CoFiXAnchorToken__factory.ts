...
import type { CoFiXAnchorToken, CoFiXAnchorTokenInterface } from '../CoFiXAnchorToken'
...
export class CoFiXAnchorToken__factory extends ContractFactory {
  ...
  deploy(
    ...
    return super.deploy(name_, symbol_, pool, overrides || {}) as Promise<CoFiXAnchorToken>
  }
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): CoFiXAnchorToken {
