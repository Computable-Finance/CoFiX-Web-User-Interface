...
interface CoFiXAnchorTokenInterface extends ethers.utils.Interface {
  functions: {
...
export class CoFiXAnchorToken extends BaseContract {
  ...
  interface: CoFiXAnchorTokenInterface
  ...
  callStatic: {
    ...
    mint(to: string, amount: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
