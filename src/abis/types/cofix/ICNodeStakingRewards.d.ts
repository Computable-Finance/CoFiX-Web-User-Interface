...
interface ICNodeStakingRewardsInterface extends ethers.utils.Interface {
  functions: {
...
export class ICNodeStakingRewards extends BaseContract {
  ...
  interface: ICNodeStakingRewardsInterface
