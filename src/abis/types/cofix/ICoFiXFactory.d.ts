...
interface ICoFiXFactoryInterface extends ethers.utils.Interface {
  functions: {
...
export class ICoFiXFactory extends BaseContract {
  ...
  interface: ICoFiXFactoryInterface

  functions: {
    createPair(token: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>

    getPair(token: string, overrides?: CallOverrides): Promise<[string] & { pair: string }>

    allPairs(arg0: BigNumberish, overrides?: CallOverrides): Promise<[string] & { pair: string }>

    allPairsLength(overrides?: CallOverrides): Promise<[BigNumber]>

    getTradeMiningStatus(token: string, overrides?: CallOverrides): Promise<[boolean] & { status: boolean }>
    ...
    getFeeVaultForLP(token: string, overrides?: CallOverrides): Promise<[string] & { feeVault: string }>
    ...
    getController(overrides?: CallOverrides): Promise<[string] & { controller: string }>

    getFeeReceiver(overrides?: CallOverrides): Promise<[string] & { feeReceiver: string }>

    getVaultForLP(overrides?: CallOverrides): Promise<[string] & { vaultForLP: string }>

    getVaultForTrader(overrides?: CallOverrides): Promise<[string] & { vaultForTrader: string }>

    getVaultForCNode(overrides?: CallOverrides): Promise<[string] & { vaultForCNode: string }>
  }
  ...
  getTradeMiningStatus(token: string, overrides?: CallOverrides): Promise<boolean>
  ...
  estimateGas: {
    ...
    getTradeMiningStatus(token: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    getFeeVaultForLP(token: string, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    getPair(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    allPairs(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>

    allPairsLength(overrides?: CallOverrides): Promise<PopulatedTransaction>

    getTradeMiningStatus(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    getFeeVaultForLP(token: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
