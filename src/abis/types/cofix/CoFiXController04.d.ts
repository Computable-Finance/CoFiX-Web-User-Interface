...
interface CoFiXController04Interface extends ethers.utils.Interface {
  functions: {
...
export class CoFiXController04 extends BaseContract {
  ...
  interface: CoFiXController04Interface
