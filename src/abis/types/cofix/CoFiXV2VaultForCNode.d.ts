...
interface CoFiXV2VaultForCNodeInterface extends ethers.utils.Interface {
  functions: {
    ...
    'setGenesisBlock()': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'setGenesisBlock', values?: undefined): string
  ...
  decodeFunctionResult(functionFragment: 'setGenesisBlock', data: BytesLike): Result
...
export class CoFiXV2VaultForCNode extends BaseContract {
  ...
  interface: CoFiXV2VaultForCNodeInterface
  ...
  functions: {
    ...
    setGenesisBlock(overrides?: Overrides & { from?: string | Promise<string> }): Promise<ContractTransaction>
  ...
  callStatic: {
    ...
    setGenesisBlock(overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    setGenesisBlock(overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    setGenesisBlock(overrides?: Overrides & { from?: string | Promise<string> }): Promise<PopulatedTransaction>
