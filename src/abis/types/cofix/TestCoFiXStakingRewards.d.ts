...
interface TestCoFiXStakingRewardsInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'distributeReward', values: [BigNumberish]): string
...
export class TestCoFiXStakingRewards extends BaseContract {
  ...
  callStatic: {
    ...
    distributeReward(newAccrued: BigNumberish, overrides?: CallOverrides): Promise<void>
  }
