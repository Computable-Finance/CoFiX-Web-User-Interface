...
interface NNIncomeInterface extends ethers.utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'nodeCount', values: [string, string]): string
...
export class NNIncome extends BaseContract {
  ...
  callStatic: {
    ...
    nodeCount(from: string, to: string, overrides?: CallOverrides): Promise<void>
  ...
  estimateGas: {
    ...
    nodeCount(from: string, to: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
