...
import type { NestMining, NestMiningInterface } from '../NestMining'
...
export class NestMining__factory {
  static readonly abi = _abi
  static createInterface(): NestMiningInterface {
    return new utils.Interface(_abi) as NestMiningInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): NestMining {
    return new Contract(address, _abi, signerOrProvider) as NestMining
  }
}
